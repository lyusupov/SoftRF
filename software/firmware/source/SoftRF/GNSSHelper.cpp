...
const uint8_t setNav5[] PROGMEM = {0xFF, 0xFF, 0x06, 0x03, 0x00, 0x00, 0x00, 0x00,
...
static void setup_UBX()
{
  ...
  GNSS_DEBUG_PRINTLN(F("Airborne 1G navigation mode: "));
  ...
  if (!gnss_set_sucess) {
    GNSS_DEBUG_PRINTLN(F("WARNING: Unable to set airborne 1G navigation mode."));
  }
