...
void TFT_status_loop()
{
  ...
  lv_label_set_text_fmt(data_2, "%s", SKYVIEW_FIRMWARE_VERSION);
  ...
  lv_label_set_text(label_7, "Display");
  ...
  lv_label_set_text(label_8, "Connection");
  ...
  lv_label_set_text_fmt(data_8, "%s",
